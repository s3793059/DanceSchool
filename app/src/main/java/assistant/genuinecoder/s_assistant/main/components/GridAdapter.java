...
import assistant.genuinecoder.s_assistant.main.Facebook_Events.FBEvents;
...
//        notificationIntent.putExtra(MainListAdapter.IS_EMERGENCY, true);
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        if (names.get(position).toString().equals("ATTENDANCE")) {
            ...
            anim.setRepeatCount(Animation.INFINITE);
            imageView.startAnimation(anim);
        } else if (names.get(position).toString().equals("EVENTS")) {
            imageView.setImageResource(R.drawable.ic_music_note_black_24dp);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    goToFacebook();
                    //Intent launchinIntent;
...
//}
    ...
    private String getFacebookPageURL() {
        String FACEBOOK_URL = "https://www.facebook.com/pg/nrithyopasana/events/?ref=page_internal";
        ...
        try {
            ...
            if (packageManager != null) {
                ...
                if (activated != null) {
                    ...
                    if (true) {
                        facebookurl = "https://www.facebook.com/pg/nrithyopasana/events/?ref=page_internal";
                    }
                } else {
